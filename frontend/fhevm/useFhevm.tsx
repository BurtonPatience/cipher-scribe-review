    ...
    if (_isRunning === true) {
      ...
      createFhevmInstance({
        ...
        .catch((e) => {
          ...
          console.error(`[useFhevm] Provider:`, thisProvider);
          console.error(`[useFhevm] Chain ID:`, _chainIdRef.current);
          console.error(`[useFhevm] Mock chains:`, _mockChainsRef.current);
